...
/// <summary>
/// Represents a DbContext that provides multi-tenancy support.
/// This class extends DbContext to provide automatic tenant isolation
...
public abstract class TenantDbContext : DbContext
{
    ...
    /// <summary>
    /// Initializes a new instance of the TenantDbContext class.
    /// </summary>
    ...
    protected TenantDbContext(DbContextOptions options, IRequestTenant requestTenant, TimeProvider timeProvider, ITenantConfiguration tenantConfiguration) : base(options)
    {
