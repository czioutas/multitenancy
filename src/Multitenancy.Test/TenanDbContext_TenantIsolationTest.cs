...
public class TenanDbContext_TenantIsolationTest : IDisposable
{
    ...
    public TenanDbContext_TenantIsolationTest()
    {
        ...
        services.AddMultiTenancy<TestTenantDbContext>(options =>
        {
            options
                .WithDbContext<TestTenantDbContext>()
        ...
        _dbContext = new TestTenantDbContext(
            _serviceProvider.GetRequiredService<DbContextOptions<TestTenantDbContext>>(),
            _requestTenant,
            TimeProvider.System,
