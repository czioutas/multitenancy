...
public class TenantIdentityDbContextSimple_TenantIsolationTest : IDisposable
{
    ...
    private readonly TestTenantIdentityDbContextSimple _dbContext;
    private readonly ITenantService _tenantService;
    private readonly IRequestTenant _requestTenant;
    private readonly string _dbName;

    public TenantIdentityDbContextSimple_TenantIsolationTest()
    {
        ...
        services.AddMultiTenancy<TestTenantIdentityDbContextSimple>(options =>
        {
            options
                .WithDbContext<TestTenantIdentityDbContextSimple>()
                .WithUser<IdentityUser<Guid>>()
                .WithRole<IdentityRole<Guid>>()
        ...
        _dbContext = new TestTenantIdentityDbContextSimple(
            _serviceProvider.GetRequiredService<DbContextOptions<TestTenantIdentityDbContextSimple>>(),
            _requestTenant,
            TimeProvider.System,
